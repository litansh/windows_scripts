...
objFlds.Item("http://schemas.microsoft.com/cdo/configuration/smtpserver") = "192.168.90.4" 'your smtp server domain or IP address goes here
...
objMail.From = "Restart@litan.com"
objMail.To = "litan.shamir@cglms.com"
