...
'************************************
Const EmailFrom = "User-Enabled@cglms.com"
Const EmailTo = "SystemIL@cglms.com"
Const EmailSubject = "USER-ACCOUNT-Enable"
...
Const FileToBeUsed = "C:\ProgramData\IT-Scripts\EVENT_ID\USER-ACCOUNT-WAS-enable.txt"
Dim fso, f
